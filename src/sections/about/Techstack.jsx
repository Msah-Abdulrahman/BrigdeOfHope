...
function Techstack() {
  const managementPositions = [
    {
      name: 'Argwings Wamache Makau',
      position: 'Director and Founder',
      img: 'src/Assets/avatar.svg',
    },
    { name: 'Mishell Aoko Wanga', position: 'Deputy Director', img: 'src/Assets/avatar.svg' },
    { name: 'Phelix Chibengu Okwako', position: 'Chairperson', img: 'src/Assets/avatar.svg' },
